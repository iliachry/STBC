...
Adaptive MMSE achieves only 1.16× degradation from optimal ML performance while requiring 36\% less computation time, and Hybrid detection achieves 1.30× degradation with similar computational savings.
